...
- (void)updateRealSources
{
    ...
    for (i = 0; i < count; i++) {
        ...
        {
            endpoint = [[[PYMIDIRealSource alloc] initWithMIDIEndpointRef:midiEndpointRef] autorelease];
...
- (void)updateRealDestinations
{
    ...
    for (i = 0; i < count; i++) {
        ...
        {
            endpoint = [[[PYMIDIRealDestination alloc] initWithMIDIEndpointRef:midiEndpointRef] autorelease];
